...
const FULL_ANALYSIS: OllamaAnalysis = {
  ...
  detectedFields: {
    name: {
      cssSelector: 'h1.supervisor-name',
      evidence: 'Jane Smith',
      confidence: 'high',
    },
    district: {
      cssSelector: '.district-badge',
      evidence: 'District 1',
      confidence: 'high',
    },
    phone: {
      cssSelector: '.contact-block .phone',
      evidence: '(707) 565-2241',
      confidence: 'medium',
    },
    email: {
      cssSelector: '.contact-block .email',
      evidence: 'jane@county.gov',
      confidence: 'medium',
    },
    externalId: {
      cssSelector: '',
      evidence: 'requires explicit construction rule in contentGoal',
      confidence: 'low',
    },
    photoUrl: {
      cssSelector: 'img.portrait',
      evidence: 'add absolutization hint',
      confidence: 'medium',
    },
  },
};
